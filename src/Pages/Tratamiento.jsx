...
import ttmFront from '../assets/img/tratamiento-1-2.png';
import ttmBack from '../assets/img/tratamiento-1-3.png';
            ...
            <div className="container px-5 py-12 md:py-24 mx-auto">
              <div className="lg:w-4/5 mx-auto flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="w-full max-w-md">
                    ...
                    <div className="flex justify-center gap-4 mt-4">
                      <img
                        src={ttmFront}
                        alt="Frente"
                        className={`w-16 h-16 md:w-20 md:h-20 object-cover rounded cursor-pointer border-2 transition-all hover:scale-105 ${mainImage === ttmFront ? 'border-secondary' : 'border-transparent'}`}
                        onClick={() => setMainImage(ttmFront)}
                      />
                      <img
                        src={ttmBack}
                        alt="Reverso"
                        className={`w-16 h-16 md:w-20 md:h-20 object-cover rounded cursor-pointer border-2 transition-all hover:scale-105 ${mainImage === ttmBack ? 'border-secondary' : 'border-transparent'}`}
                ...
                <div className="lg:w-1/2 w-full lg:pl-6">
                  ...
                  <div className="mb-6">
                    <h1 className="text-2xl md:text-3xl font-medium mb-3 text-primary">Tratamiento Reparador</h1>
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-gray-600 ml-3 text-sm">4.8 (4 reseñas)</span>
                    </div>
                  </div>
                  ...
                  <div className="mb-6">
                    <p className="leading-relaxed text-base md:text-lg font-light text-black">
                      ...
                      <br /><br />
                      Ideal para cabellos dañados por calor o procesos térmicos intensos. Tratamiento reparador intensivo que devuelve la vitalidad natural a tu cabello.
                    </p>
                  </div>

                  {/* Precio y opciones */}
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pb-5 mb-5">
                    <span className="text-2xl md:text-3xl font-medium text-primary">$69.900 COP</span>
                  ...
                  <div className="space-y-6">
                    ...
                    <div id="beneficios" className="border-b-2 border-secondary pb-5">
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-start text-black text-base md:text-lg">
                          ...
                          Reparación, fuerza y brillo capilar
                        </li>
                        <li className="flex items-start text-black text-base md:text-lg">
                          <span className="text-accent mr-2">•</span>
                        ...
                        <li className="flex items-start text-black text-base md:text-lg">
                          <span className="text-accent mr-2">•</span>
                          Vitaminas: Biotina, Panthenol y Vitamina E
                        </li>
                        <li className="flex items-start text-black text-base md:text-lg">
                          <span className="text-accent mr-2">•</span>
                          Control de caída
                    ...
                    <div id="modo-uso" className="border-b-2 border-secondary pb-5">
                      ...
                      <p className="text-black text-base md:text-lg font-light leading-relaxed">
                        Lavar el cabello con shampoo, luego aplicar una cantidad considerable del tratamiento capilar sobre el cabello, masajear y dejar actuar durante 5-10 minutos antes de enjuagar con abundante agua.
                      </p>
                    </div>
                    ...
                    <div id="ingredientes" className="pb-5">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="bg-secondary/10 p-3 rounded-lg">
                          <span className="text-black text-base md:text-lg">Leche de Cabra</span>
                        </div>
                        <div className="bg-secondary/10 p-3 rounded-lg">
                          <span className="text-black text-base md:text-lg">Romero</span>
                        </div>
                        <div className="bg-secondary/10 p-3 rounded-lg">
                          <span className="text-black text-base md:text-lg">Embrión de Pato</span>
                        </div>
                        <div className="bg-secondary/10 p-3 rounded-lg">
                          <span className="text-black text-base md:text-lg">Aceite de Aloe vera</span>
                        </div>
                        <div className="bg-secondary/10 p-3 rounded-lg">
                          <span className="text-black text-base md:text-lg">Aceite de Argán</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                    <div className="text-center md:text-left">
                      ...
                      <p className="text-xl md:text-2xl font-light text-black mt-1">4 Opiniones</p>
                    </div>
